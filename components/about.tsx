...
export function About() {
  ...
  const importantNews = news.news.find(item => item.type === "important")

  return (
    <section id="about" className="px-6 lg:px-12 py-15 lg:py-12">
      ...
      <Card className="shadow-lg border border-slate-200 hover:shadow-xl transition-shadow duration-300">
        <CardContent className="p-6 lg:p-8 space-y-6">
          ...
          {/* Important Notice */}
          {importantNews && (
            <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mt-6 rounded-md shadow-md">
              <h4 className="font-bold">{importantNews.title}</h4>
